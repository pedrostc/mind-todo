...
describe('TodoListComponent', () => {
	...
	it('should allow adding a new todo item', async () => {
		...
		const mainAddButton = addButtons.find((button) => button.closest('.add-item') !== null);
	...
	it('should allow adding a sub-item to an item', async () => {
		...
		// Use a more specific selector for the Add button
		const addButtons = screen.getAllByText('Add');
		const subItemAddButton = addButtons.find((button) => button.closest('.add-form') !== null);
	...
	it('should allow adding a note to an item', async () => {
		...
		// Use a more specific selector for the Add button
		const addButtons = screen.getAllByText('Add');
		const noteAddButton = addButtons.find((button) => button.closest('.add-form') !== null);
	...
	it('should display the age of carried over items', () => {
		...
		const _oldItem = oldList.createItem('Old item');
